    ...
    var S = function (g) {
        ...
        function I(a, b, c) {
            ...
            g.each(b, function (d) {
                e = a._hungarianMap[d];
                if (e !== k && (c || b[e] === k))
                    "o" === e.charAt(0) ? (b[e] || (b[e] = {}), g.extend(!0, b[e], b[d]), I(a[e], b[e], c)) : b[e] = b[d]
            })
        }
        function S(a) {
        ...
        function gb(a) {
            var a = a.oBrowser, b = g("<div/>").css({position: "fixed",
                top: 0, left: 0, height: 1, width: 1, overflow: "hidden"}).append(g("<div/>").css({position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll"}).append(g('<div class="test"/>').css({width: "100%", height: 10}))).appendTo("body"), c = b.find(".test");
        ...
        function hb(a, b, c, e, d, f) {
            ...
            c !== k && (h = c, i = !0);
            for (; e !== d; )
                a.hasOwnProperty(e) && (h = i ? b(h, a[e], e, a) : a[e],
                        i = !0, e += f);
            return h
        }
        function Ga(a, b) {
            var c = m.defaults.column, e = a.aoColumns.length, c = g.extend({}, m.models.oColumn, c, {nTh: b ? b : T.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [e], mData: c.mData ? c.mData : e, idx: e});
            a.aoColumns.push(c);
            c = a.aoPreSearchCols;
        ...
        function L(a, b, c, e) {
            var d = a.aoData.length, f = g.extend(!0, {}, m.models.oRow, {src: c ? "dom" :
                        "data", idx: d});
            f._aData = b;
            a.aoData.push(f);
        ...
        function na(a, b, c, e) {
            var d = [], f = b.firstChild, h, i, j = 0, n, l = a.aoColumns, r = a._rowReadObject, e = e !== k ? e : r ? {} : [], q = function (a, b) {
                ...
                if (c === k || c === j)
                    i = l[j], n = g.trim(a.innerHTML), i && i._bAttrSrc ? (Q(i.mData._)(e,
        ...
        function kb(a) {
            ...
            for (c = l.length; b < c; b++)
                f = l[b], e = g(f.nTh).addClass(f.sClass), j && e.appendTo(d), a.oFeatures.bSort && (e.addClass(f.sSortingClass), !1 !== f.bSortable &&
        ...
        function M(a) {
            ...
            if (-1 !== g.inArray(!1, b))
                ...
                if (0 !== j.length) {
                    ...
                    c = f.sZeroRecords, 1 == a.iDraw && "ajax" == z(a) ? c = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable), b[0] = g("<tr/>", {"class": d ? e[0] : ""}).append(g("<td />", {valign: "top", colSpan: ba(a), "class": a.oClasses.sRowEmpty}).html(c))[0];
        ...
        function ub(a) {
            ...
            for (h = 0; h < c; h++)
                n = b[h], l = f[h], j = "function" == typeof n.mData ? "function" : n.mData, k.columns.push({data: j, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: {value: l.sSearch, regex: l.bRegex}}), q("mDataProp_" + h, j), e.bFilter && (q("sSearch_" + h, l.sSearch),
        ...
        function pb(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage,
                    d = a.oPreviousSearch, f = a.aanFeatures, h = '<input type="search" class="' + b.sFilterInput + '"/>', i = e.sSearch, i = i.match(/_INPUT_/) ? i.replace("_INPUT_", h) : i + h, b = g("<div/>", {id: !f.f ? c + "_filter" : null, "class": b.sFilter}).append(g("<label/>").append(i)), f = function () {
            ...
            for (f = a.aoData.length; e < f; e++)
                if (g = a.aoData[e], !g._aFilterData) {
                    ...
                    for (h = b.length; d < h; d++)
                        c = b[d], c.bSearchable ? (j = y(a, e, d, "filter"), l[c.sType] && (j = l[c.sType](j)), null === j && (j =
        ...
        function H(a, b, c) {
            for (var e = 0, d = 0, f = b.length, h, i; d < f; ) {
                ...
                for (i = c?c[d].firstChild:null; h; )
                    1 === h.nodeType && (c ? a(h, i, e) : a(h, e), e++), h = h.nextSibling,
        ...
        function Ha(a) {
            ...
            if (e || !q && !f && !d && i == ba(a) && i == n.length)
                ...
                q = g("<div/>").css(f || d ? {position: "absolute", top: 0,
                    left: 0, height: 1, right: 0, overflow: "hidden"} : {}).append(i).appendTo(k);
        ...
        function Hb(a, b) {
            for (var c, e = -1, d = -1, f = 0, h = a.aoData.length; f < h; f++)
                c = y(a, f, b, "display") + "", c = c.replace(ac, ""), c.length > e && (e = c.length, d = f);
            return d
        }
        function u(a) {
        ...
        function Ib() {
            ...
            if (a === k) {
                var b = g("<p/>").css({position: "absolute", top: 0, left: 0, width: "100%", height: 150, padding: 0, overflow: "scroll",
                    visibility: "hidden"}).appendTo("body"), a = b[0].offsetWidth - b[0].clientWidth;
        ...
        function V(a) {
            ...
            for (a = 0; a < n.length; a++) {
                ...
                for (c = f.length; b < c; b++)
                    h = f[b], i = d[h].sType || "string", n[a]._idx === k && (n[a]._idx = g.inArray(n[a][1],
        ...
        function ya(a) {
            if (a.oFeatures.bStateSave && !a.bDestroying) {
                var b = {time: +new Date, start: a._iDisplayStart, length: a._iDisplayLength, order: g.extend(!0, [], a.aaSorting), search: Ab(a.oPreviousSearch), columns: g.map(a.aoColumns, function (b, e) {
        ...
        function Mb(a, b, c) {
            var e, d;
            for (d in b)
                b.hasOwnProperty(d) && (e = b[d], g.isPlainObject(e) ? (g.isPlainObject(a[d]) || (a[d] = {}), g.extend(!0, a[d], e)) : a[d] = c && "data" !== d && "aaData" !==
        ...
        m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    "" !== t.sUrl && (g.ajax({dataType: "json", url: t.sUrl, success: function (a) {
                            S(a);
                            I(l.oLanguage, a);
                            g.extend(true, t, a);
                            ha(o)
        ...
        m.Api = t;
        g.extend(t.prototype, {any: function () {
                return 0 !== this.count()
                ...
                for (g = l.length; h < g; h++) {
                    ...
                    if ("table" === b)
                        ...
                        for (n = q.length; j < n; j++)
                            f = q[j], f = "cell" === b ? c.call(o, l[h], f.row, f.column, h, j) : c.call(o, l[h], f, h, j, m), f !== k && d.push(f)
                    }
                }
        ...
        t.register = p = function (a, b) {
            if (g.isArray(a))
                ...
                for (var d = a.split("."), f = Ub, h, i, c = 0, e = d.length; c < e; c++) {
                    ...
                    j || (j = {name: h,
                        val: {}, methodExt: [], propExt: []}, f.push(j));
        ...
        p("rows.add()", function (a) {
            var b = this.iterator("table", function (b) {
                ...
                for (h = a.length; f < h; f++)
                    c = a[f], c.nodeName && "TR" === c.nodeName.toUpperCase() ? g.push(ma(b, c)[0]) : g.push(L(b, c));
                return g
            }, 1), c = this.rows(-1);
            c.pop();
            ...
            if (!0 === a)
                ...
                var e = c[0], c = c[0].aoData[this[0]], d = [], f = function (a, b) {
                    if (g.isArray(a) || a instanceof g)
                        ...
                        a.nodeName && "tr" === a.nodeName.toLowerCase() ? d.push(a) : (c = g("<tr><td/></tr>").addClass(b), g("td", c).addClass(b).html(a)[0].colSpan = ba(e), d.push(c[0]))
                };
                f(a, b);
        ...
        m.models.oSettings = {oFeatures: {bAutoWidth: null, bDeferRender: null, bFilter: null, bInfo: null, bLengthChange: null, bPaginate: null, bProcessing: null, bServerSide: null, bSort: null, bSortMulti: null,
            ...
            sServerMethod: null, fnFormatNumber: null, aLengthMenu: null, iDraw: 0, bDrawing: !1, iDrawError: -1, _iDisplayLength: 10, _iDisplayStart: 0, _iRecordsTotal: 0, _iRecordsDisplay: 0, bJUI: null, oClasses: {}, bFiltered: !1, bSorted: !1, bSortCellsTop: null, oInit: null, aoDestroyCallback: [], fnRecordsTotal: function () {
        ...
        m.ext = v = {buttons: {}, classes: {}, errMode: "alert", feature: [], search: [], selector: {cell: [], column: [], row: []}, internal: {}, legacy: {ajax: null}, pager: {}, renderer: {pageButton: {}, header: {}}, order: {}, type: {detect: [],
                search: {}, order: {}}, _unique: 0, fnVersionCheck: m.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: m.version};
        ...
        g.extend(m.ext.classes, {sTable: "dataTable", sNoFooter: "no-footer", sPageButton: "paginate_button", sPageButtonActive: "current", sPageButtonDisabled: "disabled", sStripeOdd: "odd", sStripeEven: "even", sRowEmpty: "dataTables_empty",
        ...
        g.extend(m.ext.oJUIClasses, m.ext.classes, {sPageButton: "fg-button ui-button " +
        ...
        g.extend(!0, m.ext.renderer, {pageButton: {_: function (a, b, c, e, d, f) {
        ...
        db("");
        g.extend(!0, m.ext.renderer, {header: {_: function (a, b, c, e) {
        ...
        m.render = {number: function (a, b, c, e, d) {
        ...
        g.extend(m.ext.internal, {_fnExternApiFunc: Ob, _fnBuildAjax: ra, _fnAjaxUpdate: lb, _fnAjaxParameters: ub, _fnAjaxUpdateDraw: vb, _fnAjaxDataSrc: sa, _fnAddColumn: Ga, _fnColumnOptions: ka, _fnAdjustColumnSizing: Y, _fnVisibleToColumnIndex: la, _fnColumnIndexToVisible: aa, _fnVisbleColumns: ba, _fnGetColumns: $, _fnColumnTypes: Ia, _fnApplyColumnDefs: ib, _fnHungarianMap: X, _fnCamelToHungarian: I, _fnLanguageCompat: S, _fnBrowserDetect: gb, _fnAddData: L, _fnAddTr: ma, _fnNodeToDataIndex: function (a, b) {
            ...
            }, _fnGetCellData: y, _fnSetCellData: Ja, _fnSplitObjNotation: La, _fnGetObjectDataFn: P, _fnSetObjectDataFn: Q, _fnGetDataMaster: Ma, _fnClearTable: oa, _fnDeleteIndex: pa, _fnInvalidate: da, _fnGetRowElements: na, _fnCreateTr: Ka, _fnBuildHead: kb, _fnDrawHead: fa, _fnDraw: M, _fnReDraw: R, _fnAddOptionsHtml: nb, _fnDetectHeader: ea, _fnGetUniqueThs: qa, _fnFeatureHtmlFilter: pb, _fnFilterComplete: ga, _fnFilterCustom: yb, _fnFilterColumn: xb,
